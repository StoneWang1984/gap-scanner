"""Config — Stone 0.4.13: based on 0.4.11, remove re-entry time limit.

Changes over 0.4.11:
- Remove re-entry time stop (REENTRY_MAX_BARS_BEFORE_TARGET = 0)
  A/B testing showed re-entry time limits reduce performance by $6,507
"""
...
# ── Re-entry trade — 0.4.13: no time limit ──────────────────────────
