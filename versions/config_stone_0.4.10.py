"""Config — Stone 0.4.10: price $1-$20 + improved re-entry strategy.

Changes over 0.4.9:
- PRICE_MIN: 0.25 → 1.0 (exclude penny stocks)
- PRICE_MAX: 30 → 20 (exclude poorly performing $20-30 range)
- Re-entry: half position, ATR stop, dual-tier profit, breakeven, time stop
- Re-entry cutoff: 13:00 → 12:30
"""
