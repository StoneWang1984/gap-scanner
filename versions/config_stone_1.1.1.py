"""Config — Stone 1.1.1: hotfix for ANSI color NameError crash.

Changes from Stone 1.1 → 1.1.1:
- Fix: Add missing ANSI color constants (RED, GREEN, YELLOW, RESET) in live_trade
