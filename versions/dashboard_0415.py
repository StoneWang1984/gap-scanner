"""Stone 0.4.15 实盘监控 Dashboard — with real-time price charts"""
...
LOG_FILE = VER_DIR / "live_0415.log"
...
st.set_page_config(page_title="Stone 0.4.15 Live", page_icon="📊", layout="wide")

st.title("Stone 0.4.15 实盘监控")
